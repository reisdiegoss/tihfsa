    ...
    <div className="space-y-8 animate-fade-in pb-10">
      ...
      <div className="bg-blue-600 rounded-3xl p-8 text-white flex items-center justify-between shadow-sm relative overflow-hidden">
        ...
        <button
          ...
          className="bg-white text-blue-600 px-6 py-3 rounded-xl font-bold text-sm shadow-md hover:bg-slate-50 transition-colors relative z-10 cursor-pointer"
        >
          + Novo Chamado
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-3xl font-extrabold text-slate-800">{stats?.by_status?.["Aguardando Validação"] || 0}</p>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500">#{t.id} • {t.requester_name || "—"}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
        ...
        <div className="col-span-1 space-y-6">
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                onClick={() => navigate("/admin/tickets")}
                className="flex flex-col items-center justify-center p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:border-blue-300 hover:bg-blue-50 transition-all cursor-pointer group"
              >
              ...
              <button
                ...
                className="flex flex-col items-center justify-center p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:border-emerald-300 hover:bg-emerald-50 transition-all cursor-pointer group"
              >
              ...
              <button
                onClick={() => navigate("/admin/zabbix")}
                className="flex flex-col items-center justify-center p-4 bg-slate-50 rounded-2xl border border-slate-100 hover:border-amber-300 hover:bg-amber-50 transition-all cursor-pointer group"
              >
